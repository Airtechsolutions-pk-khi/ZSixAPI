...
namespace WebAPICode.Helpers
{
    public class DBHelper
    {
        ...
        private static readonly string connectionString = "data source=sql5053.site4now.net;initial catalog=db_a82b87_zsixrestaurant;persist security info=True;user id=db_a82b87_zsixrestaurant_admin;password=Tech@123;";
